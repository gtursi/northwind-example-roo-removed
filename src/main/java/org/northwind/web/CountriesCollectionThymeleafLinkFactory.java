...
@Component
public class CountriesCollectionThymeleafLinkFactory implements MethodLinkFactory<CountriesCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<CountriesCollectionThymeleafController> getControllerClass() {
