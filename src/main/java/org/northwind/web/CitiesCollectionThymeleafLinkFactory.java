...
@Component
public class CitiesCollectionThymeleafLinkFactory implements MethodLinkFactory<CitiesCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<CitiesCollectionThymeleafController> getControllerClass() {
