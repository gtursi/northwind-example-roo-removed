...
/**
 * = SuppliersItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = SuppliersItemThymeleafController.class)
@Component
public class SuppliersItemThymeleafLinkFactory implements MethodLinkFactory<SuppliersItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<SuppliersItemThymeleafController> getControllerClass() {
