...
@Component
public class ProductsCollectionThymeleafLinkFactory implements MethodLinkFactory<ProductsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<ProductsCollectionThymeleafController> getControllerClass() {
