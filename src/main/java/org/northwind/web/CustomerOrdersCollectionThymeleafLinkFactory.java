 ...
 */
@Component
public class CustomerOrdersCollectionThymeleafLinkFactory implements MethodLinkFactory<CustomerOrdersCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<CustomerOrdersCollectionThymeleafController> getControllerClass() {
