...
@Component
public class EmployeesCollectionThymeleafLinkFactory implements MethodLinkFactory<EmployeesCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<EmployeesCollectionThymeleafController> getControllerClass() {
