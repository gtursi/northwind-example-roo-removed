...
/**
 * = ShippersCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ShippersCollectionThymeleafController.class)
@Component
public class ShippersCollectionThymeleafLinkFactory implements MethodLinkFactory<ShippersCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<ShippersCollectionThymeleafController> getControllerClass() {
