...
@Component
public class CustomersCollectionThymeleafLinkFactory implements MethodLinkFactory<CustomersCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<CustomersCollectionThymeleafController> getControllerClass() {
