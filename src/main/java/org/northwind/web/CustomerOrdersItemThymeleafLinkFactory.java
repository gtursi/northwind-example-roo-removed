...
@Component
public class CustomerOrdersItemThymeleafLinkFactory implements MethodLinkFactory<CustomerOrdersItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<CustomerOrdersItemThymeleafController> getControllerClass() {
