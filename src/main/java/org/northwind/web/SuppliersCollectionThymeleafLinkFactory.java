...
@Component
public class SuppliersCollectionThymeleafLinkFactory implements MethodLinkFactory<SuppliersCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<SuppliersCollectionThymeleafController> getControllerClass() {
        return SuppliersCollectionThymeleafController.class;
    }
