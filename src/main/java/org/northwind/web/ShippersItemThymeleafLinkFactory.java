...
/**
 * = ShippersItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ShippersItemThymeleafController.class)
@Component
public class ShippersItemThymeleafLinkFactory implements MethodLinkFactory<ShippersItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<ShippersItemThymeleafController> getControllerClass() {
        return ShippersItemThymeleafController.class;
    }
