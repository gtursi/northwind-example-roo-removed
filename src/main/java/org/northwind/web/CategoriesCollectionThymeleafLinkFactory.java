 ...
 */
@Component
public class CategoriesCollectionThymeleafLinkFactory implements MethodLinkFactory<CategoriesCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<CategoriesCollectionThymeleafController> getControllerClass() {
