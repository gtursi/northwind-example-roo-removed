...
public class EmployeesItemThymeleafController {
    ...
    public ModelAndView update(@Valid @ModelAttribute Employee employee, @RequestParam("version") Long version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
