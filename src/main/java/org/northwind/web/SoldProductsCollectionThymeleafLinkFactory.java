...
/**
 * = SoldProductsCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = SoldProductsCollectionThymeleafController.class)
@Component
public class SoldProductsCollectionThymeleafLinkFactory implements MethodLinkFactory<SoldProductsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<SoldProductsCollectionThymeleafController> getControllerClass() {
        return SoldProductsCollectionThymeleafController.class;
    }
