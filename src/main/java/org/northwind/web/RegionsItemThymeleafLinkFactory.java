...
@Component
public class RegionsItemThymeleafLinkFactory implements MethodLinkFactory<RegionsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<RegionsItemThymeleafController> getControllerClass() {
