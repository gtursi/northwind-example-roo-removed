...
/**
 * = SoldProductsItemThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = SoldProductsItemThymeleafController.class)
@Component
public class SoldProductsItemThymeleafLinkFactory implements MethodLinkFactory<SoldProductsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<SoldProductsItemThymeleafController> getControllerClass() {
