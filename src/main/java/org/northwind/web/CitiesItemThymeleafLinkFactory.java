 ...
 */
@Component
public class CitiesItemThymeleafLinkFactory implements MethodLinkFactory<CitiesItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<CitiesItemThymeleafController> getControllerClass() {
