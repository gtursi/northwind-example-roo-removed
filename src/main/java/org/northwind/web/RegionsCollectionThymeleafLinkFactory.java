 ...
 */
@Component
public class RegionsCollectionThymeleafLinkFactory implements MethodLinkFactory<RegionsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<RegionsCollectionThymeleafController> getControllerClass() {
