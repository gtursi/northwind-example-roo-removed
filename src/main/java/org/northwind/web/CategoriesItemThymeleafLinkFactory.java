 ...
 */
@Component
public class CategoriesItemThymeleafLinkFactory implements MethodLinkFactory<CategoriesItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<CategoriesItemThymeleafController> getControllerClass() {
