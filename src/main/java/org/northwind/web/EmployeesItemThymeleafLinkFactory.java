...
@Component
public class EmployeesItemThymeleafLinkFactory implements MethodLinkFactory<EmployeesItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<EmployeesItemThymeleafController> getControllerClass() {
