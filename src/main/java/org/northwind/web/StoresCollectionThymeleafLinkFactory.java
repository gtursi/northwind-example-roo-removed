...
/**
 * = StoresCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = StoresCollectionThymeleafController.class)
@Component
public class StoresCollectionThymeleafLinkFactory implements MethodLinkFactory<StoresCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<StoresCollectionThymeleafController> getControllerClass() {
