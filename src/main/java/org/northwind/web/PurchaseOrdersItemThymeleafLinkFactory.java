 ...
 *
 */
@RooLinkFactory(controller = PurchaseOrdersItemThymeleafController.class)
@Component
public class PurchaseOrdersItemThymeleafLinkFactory implements MethodLinkFactory<PurchaseOrdersItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<PurchaseOrdersItemThymeleafController> getControllerClass() {
