...
public class CustomersItemThymeleafController {
    ...
    public ModelAndView update(@Valid @ModelAttribute Customer customer, @RequestParam("version") Long version, @RequestParam(value = "concurrency", required = false, defaultValue = "") String concurrencyControl, BindingResult result, Model model) {
