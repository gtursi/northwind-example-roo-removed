 ...
 */
@Component
public class CustomersItemThymeleafLinkFactory implements MethodLinkFactory<CustomersItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<CustomersItemThymeleafController> getControllerClass() {
