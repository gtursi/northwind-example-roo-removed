...
/**
 * = PurchaseOrdersCollectionThymeleafLinkFactory
 TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PurchaseOrdersCollectionThymeleafController.class)
@Component
public class PurchaseOrdersCollectionThymeleafLinkFactory implements MethodLinkFactory<PurchaseOrdersCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<PurchaseOrdersCollectionThymeleafController> getControllerClass() {
